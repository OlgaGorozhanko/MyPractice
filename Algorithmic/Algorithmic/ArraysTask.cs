...
namespace Algorithmic
{
    ...
    class ArraysTask
    {
        static int arraySize;  //размер одномерного массива
        static int[] array;  // одномерный массив

        // проверка на корректность ввода размера массива
        ...
        static void MaximumDoesNotDecreaseSequence(int[] array)
        {
        ...
        static void FindSummaTwoSmallestAndTwoLargestElementArray(int[] array)
        {
            int number = array[0];
            bool flag = false;
            Array.Sort(array);
